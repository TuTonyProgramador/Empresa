...
<head>
    ...
    <title>Obtener Producto Descripcion</title>
</head>
<body>
    <nav>
        <div class="logo">
    ...
    <br>
    <form action="../Controlador/controladorGetByDescrip.php" method="post">
        <label for="descripcion">Descripcion: </label>
        <input type="text" name="descripcion" id="descripcion" required>
        <br>
        <br>
        <input type="submit" id="bObtenerP" name="bObtenerP" value="Obtener Productos">
    </form>
</body>
</html>